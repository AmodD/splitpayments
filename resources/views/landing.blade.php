...
'resources/css/landing/custom.css', 
'resources/css/landing/all.min.css',
'resources/css/landing/animate.compat.css',
'resources/css/landing/bootstrap.min.css',
'resources/css/landing/demo-seo-2.css',
'resources/css/landing/magnific-popup.min.css',
'resources/css/landing/owl.carousel.min.css',
'resources/css/landing/owl.theme.default.min.css',
'resources/css/landing/simple-line-icons.min.css',
'resources/css/landing/skin-seo-2.css',
'resources/css/landing/theme-blog.css',
'resources/css/landing/theme-elements.css',
'resources/css/landing/theme-shop.css',
'resources/css/landing/theme.css',
'resources/js/landing/theme.init.js',
'resources/js/landing/custom.js',
'resources/js/landing/demo-seo-2.js',
'resources/js/landing/plugins.min.js',
'resources/js/landing/theme.js',
               'resources/js/app.js'])
					...
					<div class="container position-relative z-index-1 pt-5 mt-5">
						...
						<div class="row align-items-center pt-4">
							<div class="col-md-6 pb-5 mb-md-5">
								...
								<h1 class="text-color-dark font-weight-bold text-10 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">Start Growing Your Business Trough Better SEO</h1>
					...
					<div class="container position-relative z-index-1 mt-3 mb-5">
						...
						<div class="row">
							<div class="col-lg-6 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="450">
								...
								<p class="lead pe-5 mb-4 pb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur.</p>
				...
				<div class="footer-copyright bg-color-quaternary">
					<div class="container py-2">
						...
						<div class="row justify-content-center py-4">
							<div class="col-auto">
								<p class="text-color-light opacity-5 text-3">Porto SEO © Copyright 2023. All Rights Reserved.</p>
							</div>
						</div>
					</div>
				</div>
